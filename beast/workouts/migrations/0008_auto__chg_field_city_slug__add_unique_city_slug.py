...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'workouts_city', 'slug', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=256))
        # Adding unique constraint on 'City', fields ['slug']
        db.create_unique(u'workouts_city', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'City', fields ['slug']
        db.delete_unique(u'workouts_city', ['slug'])


        # Changing field 'City.slug'
        db.alter_column(u'workouts_city', 'slug', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    models = {
        ...
        u'workouts.location': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['workouts.City']", 'null': 'True'}),
        ...
        u'workouts.userprofile': {
            ...
            'cities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'users'", 'blank': 'True', 'to': u"orm['workouts.City']"}),
